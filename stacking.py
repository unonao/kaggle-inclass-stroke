...
# data path
oof_path = [
    "data/output/oof_lightgbm001.csv",
    "data/output/oof_logistic_reg_000.csv",
    "data/output/oof_nn3_000.csv",
]
test_path = [
    "data/output/sub_lightgbm001.csv",
    "data/output/sub_logistic_reg_000.csv",
    "data/output/sub_nn3_000.csv",
]
...
def load_train_label(path="data/input/stroke_train.csv"):
